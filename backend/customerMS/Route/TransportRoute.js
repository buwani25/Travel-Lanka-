...
router.post('/', async (req, res) => {
  const { tourId, vehicleType, driverRequired,vehicleModel,numPassengers,specialRequirements,pickupDate, dropoffDate} = req.body;
  try {
